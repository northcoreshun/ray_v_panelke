...
#РЕЖИССУРА АЛЮМИНИЯ
#ГЕНЕРАТОР СПРАЙТОВ, ТИТРОВ
#CAMERA
#функция ВЕРНУТЬСЯ НАЗАД, анимация перемотки SaturationMatrix(0,0)
#Обновление 2.8:
#оптимизирован звук - конвертация всех треков в легкий формат ogg, один трек сокращен, ещё один заменён
#проведена автоинициализация всех файлов
#переработана большая часть анимаций, добавлены новые
#обработаны оставшиеся фоны
...
screen ichoose_centerscrn:
    frame:
        ...
        background None
        imagebutton:
            idle "gui accessibility_vignette"
            align (.5,1.)
            yoffset 8
            at ich_trans_hoverbox
            action Return()
        imagebutton: 
            idle "gui arrow_single"
...
label b2:
    call showtext("textimg up_a_rvp","textimg dn_a_rvp")
    $ s="""
    26 июня 1987 года, г. Лениноморск.

    Лена: Алис, я не знаю. Он какой-то грустный в последнее время. Боюсь, я ему надоела.
    Алиса: С чего ты взяла?
    Лена: Ну просто… в лагере я лезла к нему. Под руку его взяла один раз. На острове когда были, голову на плечо положила и мы заснули.
    А потом я в последний день затеяла историю, что нам надо остаться вдвоём с ним. Проявляла инициативу, одним словом.
    Лена: Мне кажется, это из-за меня он остался у нас. Если говорит, что приехал из другого времени.
    Неужели я его обрекла на несчастье жить здесь со мной, лишила того, что он имел?
    Лена: У него же там наверняка родители были, а я… своих не имею, да ещё у Сёмы их забрала!
    Алиса: Ну, хватит, Лен. Не накручивай себя. Во-первых, это он не из-за тебя грустный ходит, возможно. Во-вторых, а зачем ты его рассказы о прошлом слушаешь?
    Как ты вообще поверила в эту историю с попаданием из будущего, непонятно.
    Алиса: Ладно. Кажется, я могу помочь. Добавить немного романтики, так сказать.


    Михаил: Тьфу-ты! А говорил – нормально выточишь!
    Михаил: Семыч, это никуда не годится. Мне надоело за тобой брак забирать. Давай дуй в путягу. Там научат работать.
    Семён: Да я же и так работаю!
    Михаил: Надо, чтобы тебя нормально научили! У меня нет времени возиться с тобой особо. У нас план горит, мне премия нужна.
    Семён: Да мне немного попрактиковаться надо и…
    Михаил: Ты уже какую деталь испортил, практикант херов! У меня нет уже для тебя лишних, остальные надо выточить… идеально, блин. Задал мне задачку.
    Михаил: Вот что я тебе скажу. Не надо тут строить из себя тут токаря хрен знает какого разряда. Приходи с документами на Горького, пять. Все мы через неё, родимую, прошли.
    Михаил: Всё, разговор окончен.
    Семён: Смена, кстати, тоже.
    Михаил: Так чего стоишь? Давай в раздевалку и домой. Я тебя ждать не собираюсь. Просто в цеху закрою и будешь ночевать тут, хехе.
    Сказал Михаил и засмеялся при этом так неприятно.
    ...
    Ну вот опять! Моя попытка доказать моему наставнику, что я чего-то стою, провалилась.
    Нет, я понимаю, я новичок в токарном деле, со станком на "вы". Но идти в ПТУ?! Да помилуйте! Там же контингент - оторви и выбрось. Ещё ведь знакомиться с ними.
    Зачем мне кто-то ещё? Есть мой учитель токарного дела Михаил, есть моя любовь Лена и её подруга Алиса. Всё, мне больше никого не надо.
    Настрой портила и простая усталость, идти до Лены приходится полчаса по жаре.
    Ох, не стоило мне тогда быть таким брюзгой.
    Пройдя знакомый мне маршрут, я пришёл к интернату. И снова меня встретила Лена.
    Лена: Сёма, привет. Как дела?
    Семён: Да так, пойдёт.
    Позитив Лены действовал мне на нервы.
    Лена: Что-то случилось?
    Семён: Да ничего не случилось. Всё нормально.
    Лена: Ну ладно. Пойдём за мной, покажу кое-что.
    Мы пошли в какой-то незнакомый район. Дорога была недолгой, но от усталости ногам было тяжело. Подошли к многоэтажке. Я ещё не видел здесь таких новых домов.
    Семён: Лена, куда мы идём?
    Лена: Сейчас узнаешь.
    Загадочно улыбнувшись, сказала она.
    Мы зашли и поднялись на лифте на самый высокий этаж. Спасибо хоть, что не по лестнице.
    Опять какой-то сюрприз от Лены. Нет, я как бы не против, но сейчас я немного не в духе после смены.
    Интересно, зачем она меня сюда привела? Знакомство с её загадочными родителями? Я сейчас не готов к такой ответственной миссии.
    Семён: Не нравится мне всё это.
    Лена: Ну, подожди немного.
    Мы вышли на девятом этаже. Чуть замешкавшись, Лена подошла к лестнице и стала подниматься.
    Семён: Что ты делаешь?
    Лена: Сейчас узнаешь.
    Лена становилась всё взволнованнее. Я не придал этому значения, а зря.
    Она достала ключ и стала открывать люк. Мы поднялись на крышу.
    Нам открылся вид на город.
    Лена: Ну, как тебе?
    Мне это всё надоело окончательно. Ещё сейчас нас с Леной увидит кто-нибудь. Проблемы начнутся.
    Семён: Ну и зачем это всё?
    Лена: Тебе не нравится?
    Лена часто дышала от подъёма, но больше от волнения.
    Семён: Вообще не нравится, если честно.
    Семён: Я весь день работал, потом ты меня тащишь куда-то на крышу!
    Лена: Ну да, наверное, зря это всё было.
    Семён: Да уж.
    Лена: Я такая дура.
    Семён: В смысле?
    Лена: Да ладно, не молчи уж!
    Лена повысила голос.
    Семён: Ты о чём?
    Она окончательно разозлилась.
    Лена: Да не скрывай!
    Семён: Чего я скрываю?
    Лена: Совсем меня за дуру держишь?! Думаешь, я не замечаю?!
    Лена: Я тебе надоела, да?! Разонравилась?!
    Лена: Привязалась в лагере ненормальная и никак от неё не избавишься!
    Семён: Чего...
    Лена: А ты не переживай, Сём. Я тебя избавлю от этого груза!
    Лена: Сейчас прыгну! И будешь свободен!
    Лена резко дернулась к краю!
    Я бросился за ней. Вроде бы мы и не стояли близко к краю, но всё решали секунды. Перехватить Лену удалось в паре метров.
    Я схватил её со спины.
    Ещё немного, и было бы поздно.
    Семён: Ты что творишь?!
    Лена: Пусти! Я не хочу тебе мешать жить!
    Семён: Да никому ты не мешаешь!
    Лена: Но ты же несчастный! Я тебе надоела!
    Семён: Да ты чего, блин?! Я же тебя люблю!
    Лена: Правда?
    Семён: ДА ПРАВДА!
    Крикнул я ей в ухо.
    Лена перестала вырываться из объятий.
    Лена: Отпусти меня.
    Семён: Не будешь с крыши прыгать, пущу.
    Лена: Не буду.
    Но я не отпустил Лену. Слишком уж боялся за неё в тот момент. Развернул к себе и прижал.
    Семён: Лен, ты чего творишь?
    Лена: Не знаю, просто… я думала, что мучаю тебя своей привязанностью.
    Семён: Да ну нет, конечно! С чего ты взяла?
    Лена: А чего ты хмурый такой в последнее время?
    Сказала она с некоторой горечью в голосе.
    Семён: Да это не из-за тебя.
    Лена: А из-за чего?
    Семён: Ну…
    Лена: Давай говори!
    Семён: Ну,  работа… денег нет.
    Лена: Пон-я-я-я-тно.
    Лена: Что-то ещё?
    Семён: С Мишей поругался, токарем своим на заводе. Деталь хотел выточить, запорол.
    Лена помолчала.
    Лена: А я думала, я тебе навязываюсь.
    Семён: С чего ты взяла?
    Лена: Ну, лезла к тебе в лагере.
    Семён: Лезла и ладно. Я не против.
    Лена: Это хорошо.
    Лена: Сём, мне что-то плохо.
    Семён: Тебе помочь? Может в больницу отвести?
    Лена: Давай просто сядем.
    Мы с Леной сели на крышу. Лена устало опёрлась на меня и закрыла глаза.
    Прямо как тогда, на острове, когда пошли за земляникой.
    Так мы сидели какое-то время. Я задумался.
    Опять Лена выкинула какой-то сюрприз. А я её неправильно понял и это чуть не случилось страшное. Понимаю, я её задел. Но прыгать с крыши…
    Надо будет поговорить с ней.
    Сейчас всё, что мне оставалось делать – смотреть на закат, красящий город золотым цветом.
    Лена очнулась от дрёмы.
    Семён: Как себя чувствуешь? Может, пойдём отсюда?
    Лена: Да, давай.
    Семён: Лен, а зачем мы вообще сюда пришли?
    Лена: Полюбоваться.
    Семён: Давай в другой раз как-нибудь, хорошо?
    Лена: Хорошо.
    Мы спустились обратно. Я решил спросить.
    Семён: А откуда у тебя ключ?
    Лена: Алиса дала.
    Семён: А у неё он откуда?
    Лена: Ты Алису не знаешь?
    К Лене наконец вернулся прежний весёлый вид.
    Семён: Я с вами не так давно знаком.
    Лена: Она и не такое может.
    Семён: Впрочем, это в её репертуаре.

    До интерната мы шли молча.
    Лена: Сёма.
    Семён: Да, Лен?
    Лена: Прости меня за всё это.
    Семён: Я сам виноват. 
    Лена: Нет, правда. Мне стыдно, что я такую истерику устроила на ровном месте.
    Семён: Давай завтра сходим куда-нибудь? Только без перепадов высоты.
    Лена: Хорошо! Мы завтра с Алисой в библиотеку собирались.
    Семён: Пойдёт.
    Лена: А теперь, иди домой и отдыхай! И чтобы больше на усталость не жаловался!
    Весело сказала Лена и убежала к себе. Я проводил её взглядом.
    Обдумывая произошедшее, на ум приходило одно.
    Я совершенно не понимаю Лену.
    """