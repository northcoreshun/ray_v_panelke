...
Алиса: Конечно, ты не понимаешь её.
Алиса: Да ты вообще, похоже, девушек не понимаешь!
Алиса: Что это вообще за поведение такое? Она для тебя постаралась, не побоялась залезть на крышу. А он нос воротит, не нравится ему, видите ли!
Алиса: А если бы не спас? Я бы без лучшей подруги осталась! Да будь я там, ты бы с той крыши вслед за ней полетел!
Семён: Я бы сам за ней прыгнул. И без твоей помощи.
Алиса слегка опешила от моего ответа.
Семён: Не понимаю, зачем она так? Да, я ворчал тогда, но это не повод же сигать с крыши! Всегда же можно поговорить, я не знаю… 
Алиса: А тебе всё расскажи!
Алиса: Сама не знаю. Лена, она... себе на уме. Но так как ты с ней повёл, точно нельзя.
Семён: Признаю, был неправ. Но не убивать же ей себя из-за одной ссоры!
Семён: Она из-за пустяков придумала вину и возненавидела себя. Зачем так делать?
Алиса: С ней произошло много нехорошего. Это её поломало.
Семён: А что с ней случилось?
Алиса: Узнаешь сам от Лены, если не угробишь её раньше времени.
Семён: Понятно. Кстати, почему она пошла не с нами?
Алиса: Любит подольше посидеть и почитать. И пошла пораньше.
Мы дошли до библиотеки, где нас встретила Лена.
Лена: Я подумала, тебе наверное стоит начать с изучения истории.
Лена: Ты знаешь историю нашей страны? Кто возглавлял коммунистическую партию?
Семён: Ну, как же, Ленин, Сталин, потом Хрущёв.
Вдруг Лена злобно сверкнула глазами.
Лена: Кто?! Хрущёв?! Этот оппортунист?! Управлял страной?!
Своим криком Лена нарушила тишину в библиотеке. Благо никого кроме нас поблизости не было.
Семён: А у вас не так?
Лена: Нет конечно! Его арестовали и предали справедливому суду!
Семён: В моём мире… нет.
Лена: Да, не повезло вам. Вот и ещё одно доказательство, что Семён из другого мира.
Алиса: Ой, да обманывает он тебя, Лен!
Семён: Что значит обманывает?!
Лена подошла к стеллажу и начала изучать его.
Лена: Ну обманывает, не обманывает… а кое-что надо будет прочитать.
Лена: Нет, это не здесь. Подождите, я посмотрю в другой секции.
Мы остались с Алисой. Я изучал полки, она читала журнал. Так прошло минут пять.
Я решил у неё спросить.
Семён: Алис, что это с ней?
Алиса: О чем это ты?
Семён: Уж больно у неё трепетное отношение к коммунизму.
Алиса: Лена у нас идейная. До сих пор верит в эти все идеалы коммунизма. Я никогда не верила, а она – всю жизнь.
Алиса: Я её даже уважаю. Она не как эти лицемеры в комитетах, которые с холёными лицами зовут тебя надрываться, чтобы перевыполнить план.
Алиса: А Лена… она будто герой фильма про революцию во плоти. Хочет счастья для всего человечества. Готова поделиться последним, что у неё есть.
Алиса: Были бы все, да хотя бы половина людей, как она – действительно коммунизм бы настал.
Алиса снова начала читать что-то в журнале.
Алиса: Так что Лена действительно особенная.
Семён: Пожалуй, мне бы пригодилась помощь в том, чтобы понять Лену.
Алиса: Знаешь, тебе повезло.
Алиса: У меня есть то, что тебе поможет.
...
Алиса: Вот смотри, тут пишут, что люди делятся на дюжину типов.
Семён: Алис, серьёзно?
Алиса: Да подожди ты! Так вот, тут есть такой тип и это буквально Лена.
Алиса: Ну, сам почитай.
...
“Женщины-Львы — противоречивые натуры, сила и гордость которых входит в резонанс с сентиментальностью и потребностью в любви и восхищении. Женщина-Лев почти на физическом уровне нуждается не просто во внимании, но в любви на грани фола, отречении, жертвенности и желании партнера раствориться в ее интересах.
...
В работе Львицы — настоящие профи, берущие любые высоты харизмой и трудолюбием. Большие любительницы роскоши, женщины-Львы чаще других тратят деньги на покупки, удовольствия, развлечения, уход за собой и подарки любимым. Также они являются великолепными хозяйками и любительницами устраивать вечеринки и приемы, тем самым подчеркивая свой статус и умение блистать в качестве хозяйки вечера.”
#конец nvl режима

Алиса: Ну что, согласен со мной?
Семён: Да как тебе сказать…
Лена: Что вы там нашли такого интересного?
Алиса: Лен, смотри! Мне кажется тут тебя описывают.
Лена почитала это, затем полистала журнал и нахмурилась.
Лена: Смотри Алис. Тут написано, что это свойственно тем, кто родился с 23 июля по 23 августа.
Алиса: Ну… да.
Лена: А ничего, что у меня день рождения в конце сентября?!
Алиса: Ой… ну тут… ошибка какая-то.
Алиса ушла с журналом, густо покраснев.
Мы с Леной остались вдвоём.
Лена: А тебе нравится?
Семён: Что?
Лена: Делить людей на типы.
Семён: Не очень, если честно. Но то что Алиса показала – тут какое-то сходство есть.
Лена: Я и не отрицаю.
Лена: Просто мне не нравится эти ярлыки. В школе я тихоня и отличница. Вот у всех и складывается образ тихой девочки.
Лена: Вообще они правы, но... Но я чувствую, что не всегда мыслю себя в соответствии этим описаниям.
Лена: Всё-таки живого человека нельзя подогнать под какие-то шаблоны.
Лена: Меня тянет к чему-то противоположному и незнакомому мне. Это одна из причин, почему мы дружим с Алисой. И нам интересно проводить время вместе.
Лена: Иногда я тоже хочу что-нибудь такое эдакое выкинуть!
Семён: Что же, например?
Лена: Например, пойти с любимым человеком на крышу, куда лазить нельзя, но приятно там находится. А ему не нравится.
Семён: Хорошая идея, на самом деле.
Лена: Правда?
Семён: Да! Давай туда ещё раз сходим.
Лена: Ну, у нас с Алисой и ключей других нет.
Лена состроила ехидную рожицу.
Алиса: Ребят, я нашла!
Алиса вернулась к нам с тем же журналом.
Алиса: Вот эти периоды по месяцам это про нахождение Солнца в созвездии.
Алиса: Но есть ещё и Луна. Так что, возможно, у тебя Луна во Льве и всё сходится!
Лена хихикнула.
Лена: Может быть, Алиса. Может быть.
