...
#подумать как сделать дрожащими буквами, возможно через text
    call screentext_rvp("Я даже не видел её лица в тот момент.",.9,.6,1.)
...
#грузить нанобанану или Тимси, чтобы сделать визуал из артов ВадимЗы
#    pause 1
#    scene bg bedroom_rvp with dissolve
